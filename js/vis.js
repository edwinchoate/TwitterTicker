...
function updateSentiView(hashtable) {
    ...
    Bubbles = function () {
        ...
        transformData = function (rawData) {
            rawData.forEach(function (d) {
                d.totalPop = parseInt(d.totalPop);
    ...
    $(function () {
        ...
        data = loadSentimentData(hashtable);
        console.log("databetaman", data);
        display = plotData("#vis", data, plot);
    });
}

function loadSentimentData(hashtable) {
    var bubblesToPlot = [];
    var myLength = selectedCompanies.length;
    for (var i = 0; i < myLength; i++) {
        companyName = selectedCompanies[i];
        var keywordToDataMap = hashtable.get(companyName);
        console.log("PLESE LORD JESUS", keywordToDataMap);
        var keyset = keywordToDataMap.keys();
        console.log("ALL THE THINGS SIZE", keywordToDataMap.size, keyset);
        for (var j = 0; j < NUM_BUBBLES / myLength && j < keywordToDataMap.size; j++) {
